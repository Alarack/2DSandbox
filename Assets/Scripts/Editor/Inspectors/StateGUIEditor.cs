...
namespace LL.CustomUI {

    [CustomEditor(typeof(State))]
    public class StateGUIEditor : Editor {

        private SerializedObject serializedState;
        private ReorderableList onFixedUpdateList;
        private ReorderableList onUpdateList;
        private ReorderableList onEnterList;
        private ReorderableList onExitList;
        private ReorderableList Transitions;

        private bool showDefaultGUI = false;
        ...
        private void SetupReorderableLists()
        {
            ...
            //onFixedUpdateList = new ReorderableList(serializedState, serializedState.FindProperty("onFixed"), true, true, true, true);
            ...
            //HandleReorderableList(onFixedUpdateList, "On Fixed");
